...
const Statistics = () => {
    return (
        ...
        <div className="xl:px-20 px-6 py-20 xl:mx-auto xl:container">
            ...
            A Decade of Dedication <br className="md:block hidden" />
            ...
            <div className="md:mt-14 mt-4 relative sm:flex items-center justify-center">
                ...
                <div className="shadow-lg xl:p-6 p-4 sm:w-auto w-full bg-white sm:absolute relative z-20 mt-4 left-0 xl:ml-56 sm:ml-12 xl:-mt-40 sm:-mt-12">
                    ...
                    <p className="text-base leading-4 xl:mt-4 mt-2 text-gray-600">Retreats Hosted</p>
                </div>
                <div className="shadow-lg xl:p-6 p-4 w-48 sm:w-auto  bg-white sm:absolute relative z-20 mt-4 xl:mt-80 sm:mt-56 xl:-ml-0 sm:-ml-12">
                    <p className="text-3xl font-semibold text-gray-800">90%</p>
                    <p className="text-base leading-4 xl:mt-4 mt-2 text-gray-600">Success Rate</p>
                </div>
                <div className="shadow-lg xl:p-6 p-4 sm:w-auto w-full bg-white sm:absolute relative z-20 md:mt-0 sm:-mt-5 mt-4 right-0 xl:mr-56 sm:mr-24">
                    <p className="text-3xl font-semibold text-gray-800">40%</p>
                    <p className="text-base leading-4 xl:mt-4 mt-2 text-gray-600">Success Rate</p>
                </div>
            </div>
        </div>
