    ...
    >
      ...
      <div className="hero-content text-center text-neutral-content">
        <div className="max-w-md">
          <div
           className="form-control space-y-3  absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 ">
              <h1  className="mb-5 text-black text-xl md:text-2xl  lg:text-4xl whitespace-nowrap font-bold">Embark on a Journey of Wellness</h1>
             ...
             <Link to='/blogs'> <button data-aos="flip-up"
          className="btn btn-sm btn-neutral mx-auto w-36">Read More</button></Link>
          </div>
